...
<body>
    ...
    <div class="header__inner">
      <h1 class="header__logo">
        <a href="<?php echo esc_url( home_url( '/' ) ); ?>">
          <img src="<?php echo get_theme_file_uri(); ?>/assets/images/common/header_logo.svg" alt="ロゴ">
        </a>
      </h1>
        ...
        <ul class="header-nav__list">
          <li class="header-nav__item header-nav__item--has-submenu">
            <a href="<?php echo esc_url( home_url( '/psychological-counseling/' ) ); ?>"
              class="header-nav__link js-dropdown-toggle" aria-expanded="false"
              aria-controls="submenu-counseling1">心理カウンセリング</a>
            <ul class="dropdown" id="submenu-counseling1" role="menu" aria-label="心理カウンセリングのメニュー">
              <li class="dropdown__item" role="none">
                <a class="dropdown__link" href="<?php echo esc_url( home_url( '/fap-therapy/' ) ); ?>"
          ...
          <li class="header-nav__item header-nav__item--has-submenu">
            <a href="<?php echo esc_url( home_url( '/trauma-counseling/' ) ); ?>"
              class="header-nav__link">トラウマカウンセリング</a>
            <ul class="dropdown" id="submenu-counseling2" role="menu" aria-label="トラウマカウンセリングのメニュー">
              <li class="dropdown__item" role="none">
                <a class="dropdown__link" href="<?php echo esc_url( home_url( '/fap/' ) ); ?>"
                  role="menuitem">FAP療法®について</a>
              </li>
              <li class="dropdown__item" role="none">
          ...
          <li class="header-nav__item">
            <a href="<?php echo esc_url( home_url( '/blog/' ) ); ?>" class="header-nav__link">ブログ</a>
          </li>
          <li class="header-nav__item">
            <a href="<?php echo esc_url( home_url( '/company/' ) ); ?>" class="header-nav__link">会社概要</a>
          </li>
          <li class="header-nav__item">
            <a href="<?php echo esc_url( home_url( '/faq/' ) ); ?>" class="header-nav__link">よくあるご質問</a>
          </li>
        </ul>
      </nav>
  ...
  <header class="header header--mobile u-mobile">
    <div class="header__inner inner">
      <h1 class="header__logo">
        <a href="<?php echo esc_url( home_url( '/' ) ); ?>">
          <img src="<?php echo get_theme_file_uri(); ?>/assets/images/common/header_logo-sp.svg" alt="ロゴ">
        </a>
      </h1>
          ...
          <div class="header__contact header-nav__cta header-drawer__cta">
            <div class="contact-info">
              <div class="contact-info__phone">
                <span class="contact-info__icon">
                  <img src="<?php echo get_theme_file_uri(); ?>/assets/images/common/tel_icon-blue.svg" alt="phone"
                    class="contact-info__icon-img">
                </span>
                <span class="contact-info__number">03-3433-2721</span>
              </div>
