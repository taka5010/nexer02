  ...
  <section class="intro">
    <div class="intro__inner inner">
      ...
      <div class="intro__image-wrapper">
        <img class="intro__image" src="./assets/images/common/trauma_intro.jpg" alt="カウンセリングを行う医師と相談者" loading="lazy">
      </div>
    </div>
  </section>
      ...
      <ol class="counseling-points__list content03__items">
        <li class="content03__item">
          <div class="content03__item-img">
            <img src="./assets/images/common/trauma-counseling_img01.jpg" alt="省略">
          </div>
        ...
        <li class="content03__item">
          <div class="content03__item-img">
            <img src="./assets/images/common/trauma-counseling_img02.jpg" alt="省略">
          </div>
          <div class="content03__item-text-wrap">
            <h3 class="content03__item-title content03__title">
        ...
        <li class="content03__item">
          <div class="content03__item-img">
            <img src="./assets/images/common/trauma-counseling_img03.jpg" alt="省略">
          </div>
          <div class="content03__item-text-wrap">
            <h3 class="content03__item-title content03__title">
      ...
      <div class="counseling__cards card05-items">
        <div class="counseling__card card05">
          <div class="card05__image">
            <img src="./assets/images/common/target_img01.jpg" alt="" loading="lazy">
          </div>
        ...
        <div class="counseling__card card05">
          <div class="card05__image">
            <img src="./assets/images/common/target_img02.jpg" alt="" loading="lazy">
          </div>
          <div class="card05__content">
            <h3 class="card05__title">
              自己肯定感が低い方
        ...
        <div class="counseling__card card05">
          <div class="card05__image">
            <img src="./assets/images/common/target_img03.jpg" alt="" loading="lazy">
          </div>
          <div class="card05__content">
            <h3 class="card05__title">
              心の重荷を軽くしたい方
  ...
  <section class="counseling-methods">
    <div class="counseling-methods__inner inner">
      ...
      <ol class="counseling-methods__list content03__items">
        <li class="content03__item">
          <div class="content03__item-img">
            <img src="./assets/images/common/counseling-methods_img01.jpg" alt="省略">
          </div>
          <div class="content03__item-text-wrap">
            <h3 class="content03__item-title content03__title">
        ...
        <li class="content03__item">
          <div class="content03__item-img">
            <img src="./assets/images/common/counseling-methods_img02.jpg" alt="省略">
          </div>
          <div class="content03__item-text-wrap">
            <h3 class="content03__item-title content03__title">
        ...
        <li class="content03__item">
          <div class="content03__item-img">
            <img src="./assets/images/common/counseling-methods_img03.jpg" alt="省略">
          </div>
          <div class="content03__item-text-wrap">
            <h3 class="content03__item-title content03__title">
    ...
    <div class="counseling-approaches__inner inner">
      ...
      <div class="counseling__cards card04-items">
        <a href="/fap-therapy" class="counseling__card card04">
          <div class="card04__image">
            <img src="./assets/images/common/counseling_img03.jpg" alt="心理カウンセリングのイメージ" loading="lazy">
          </div>
          <div class="card04__content">
            <h3 class="card04__title">
              FAP療法®について
      ...
      <ol class="flow__list content02__items">
        <li class="content02__item">
          <div class="content02__item-img">
            <img src="./assets/images/common/flow_img01.jpg" alt="省略">
          </div>
        ...
        <li class="content02__item">
          <div class="content02__item-img">
            <img src="./assets/images/common/flow_img02.jpg" alt="省略">
          </div>
          <div class="content02__item-body">
        ...
        <li class="content02__item">
          <div class="content02__item-img">
            <img src="./assets/images/common/flow_img03.jpg" alt="省略">
          </div>
          <div class="content02__item-body">
      ...
      <div class="voice__cards voice-cards">
        <div class="voice__card voice-card">
          <div class="voice-card__avatar">
            <img src="./assets/images/common/voice_icon-woman02.svg" alt="Eさん" loading="lazy">
          </div>
        ...
        <div class="voice__card voice-card">
          <div class="voice-card__avatar">
            <img src="./assets/images/common/voice_icon-man01.svg" alt="Fさん" loading="lazy">
          </div>
          <div class="voice-card__content">
            <div class="voice-card__profile">
    ...
    <div class="content01__inner inner">
      <div class="content01__layout">
        <div class="content01__image">
          <img src="./assets/images/common/psychology_img.jpg" alt="カウンセリングの様子" loading="lazy">
        </div>
